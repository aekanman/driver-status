...
import com.gm.android.DriverStatus.R;
...
public class sleepHistory extends AppCompatActivity {
                ...
                .enableAutoManage(this, 0, new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(ConnectionResult result) {
                        Log.i(TAG, "Google Play services connection failed. Cause: " +
                                result.toString());
                        Snackbar.make(
                                sleepHistory.this.findViewById(R.id.main_activity_view),
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_delete_data) {
            ...
            Intent intent = new Intent(sleepHistory.this, MainActivity2.class);
